  ...
  return (
    <div className="space-y-3">
      ...
      <details className="group/details">
        <summary className="px-3 py-2 bg-[#0A0A0A]/50 border border-[#3A3A3A]/50 rounded-lg cursor-pointer hover:border-purple-500/50 transition-colors list-none">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-xs text-purple-400 font-medium">📋 Logo Details</span>
